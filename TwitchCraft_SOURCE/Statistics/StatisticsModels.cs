...
internal class CommandStatisticsBucket
{
...
internal sealed class SessionStatistics : CommandStatisticsBucket
{
...
internal sealed class LifetimeStatistics : CommandStatisticsBucket
{
    public long Deaths { get; set; }
