...
internal static class JsonExportWriter
{
    ...
    public const string EditingWarning = "Editing these JSON files will NOT affect TwitchCraft. To change real TwitchCraft data, edit the .db files with a SQLite editor while TwitchCraft is shut down.";
