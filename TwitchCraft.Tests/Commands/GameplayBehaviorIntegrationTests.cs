...
public sealed class GameplayBehaviorIntegrationTests
{
    ...
    [Fact]
    public async Task EffectCommand_DeliversValidEffectsAndRejectsInvalidCountsWithoutExtraCharge()
    {
    ...
    [Fact]
    public async Task EnchantCommand_RebuildsHeldItemsAndScalesCostAcrossTargets()
    {
    ...
    [Fact]
    public async Task RenameCommand_PreservesHeldItemsAndScalesCostAcrossTargets()
    {
    ...
    [Fact]
    public async Task SwarmCommand_SpawnsFiveDistinctMobsAndChargesOnce()
    {
        await using MinecraftRuntimeScenario scenario = await StartAsync();
        scenario.Runtime.Tokens.Award("viewer", 100);
        int cursor = scenario.CaptureCommandCursor();
    ...
    [Fact]
    public async Task MlgCommand_DispatchesBothDimensionSafeBranchesAndChargesOnce()
    {
        await using MinecraftRuntimeScenario scenario = await StartAsync();
        scenario.Runtime.Tokens.Award("viewer", 200);
        int cursor = scenario.CaptureCommandCursor();
    ...
    [Fact]
    public async Task SlaughterCommand_RestoresMobLootAfterTheKillAndChargesOnce()
    {
        await using MinecraftRuntimeScenario scenario = await StartAsync();
        scenario.Runtime.Tokens.Award("viewer", 100);
        int cursor = scenario.CaptureCommandCursor();
