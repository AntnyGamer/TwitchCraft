...
public sealed class MinecraftItemEnchantHelperTests
{
    [Fact]
    public void ChooseRandomEnchant_AlwaysUsesTheVanillaMaximumLevelRange()
    {
    ...
    [Fact]
    public void ChooseRandomEnchant_OnlyIncludesMaceEnchantmentsWhenSupported()
    {
        ...
        for (int seed = 0; seed < 500; seed++)
        {
            MinecraftItemEnchantHelper.ChooseRandomEnchant(new Random(seed), false, out string oldVersionEnchant, out _, out _);
            Assert.DoesNotContain(oldVersionEnchant, maceEnchantments);

            MinecraftItemEnchantHelper.ChooseRandomEnchant(new Random(seed), true, out string newVersionEnchant, out _, out _);
    ...
    [Fact]
    public void TryBuildForcedEnchantCommand_AddsConflictingEnchantToAnyItemUsing1205ComponentShape()
    {
        ...
        bool result = MinecraftItemRenameHelper.TryBuildForcedEnchantCommand(
            "@s",
            selectedItem,
            "smite",
            4,
    ...
    [Fact]
    public void TryBuildForcedEnchantCommand_ReplacesSameEnchantLevelWithoutRemovingConflicts()
    {
        ...
        Assert.True(MinecraftItemRenameHelper.TryBuildForcedEnchantCommand(
            "@s",
            selectedItem,
            "smite",
            4,
    ...
    [Fact]
    public void TryBuildForcedEnchantCommand_UsesFlattenedComponentShapeFor1215AndNewer()
    {
    ...
    public void TryBuildForcedEnchantCommand_RejectsAnEmptyHand(string selectedItemData)
    {
        Assert.False(MinecraftItemRenameHelper.TryBuildForcedEnchantCommand(
            "@s",
            selectedItemData,
            "sharpness",
            5,
    ...
    [Fact]
    public void BuildVanillaEnchantCommand_ProvidesAChargeableEmptyHandFallback()
    {
        Assert.Equal(
            "enchant @s minecraft:sharpness 5",
            MinecraftItemEnchantHelper.BuildVanillaEnchantCommand("@s", "sharpness", 5));
    }
