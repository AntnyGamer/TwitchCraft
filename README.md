 ...
 **// MULTIPLAYER:**
<br>_Making your server multiplayer is harder than just checking the Multiplayer checkbox. Here are the steps to set up a multiplayer TwitchCraft server:_
...
_Commands for the bot can be found at https://rentry.co/bot-commands
Thank you to Lil_KleinStein for inspiration for this mod, with his Minecraft streams inspiring the theme and creation!_
