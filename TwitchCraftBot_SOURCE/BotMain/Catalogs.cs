...
internal static class TwitchCraftCatalogs
{
    ...
    [
        ...
        new() { ID = "fire_resistance", MinSeconds = 20, MaxSeconds = 80, MinAmplifier = 0, MaxAmplifier = 0 },
        ...
        new() { ID = "night_vision", MinSeconds = 20, MaxSeconds = 80, MinAmplifier = 0, MaxAmplifier = 0 },
        ...
        new() { ID = "slow_falling", MinSeconds = 20, MaxSeconds = 80, MinAmplifier = 0, MaxAmplifier = 0 },
        ...
        new() { ID = "water_breathing", MinSeconds = 120, MaxSeconds = 250, MinAmplifier = 0, MaxAmplifier = 0 },
